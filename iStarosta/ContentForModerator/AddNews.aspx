<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNews.aspx.cs" MasterPageFile="~/MasterPages/iStarosta.Master"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        ...
        <tr>
            ...
            <td class="fl_r">
                <asp:Button ID="Button1" runat="server" ValidationGroup="validNews" CssClass="skip"
                    Text="Добавить новость" OnClick="Button1_Click" />
            </td>
        </tr>
    </table>
</asp:Content>
